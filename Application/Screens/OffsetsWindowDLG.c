...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "OffsetsWindow", ID_WINDOW_0, 0, 0, 800, 480, 0, 0, 0 },
  ...
  { EDIT_CreateIndirect, "Edit", ID_EDIT_1, 334, 233, 50, 25, 0, 100, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_2, 738, 128, 50, 25, 0, 100, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_3, 738, 238, 50, 25, 0, 100, 0 },
  ...
  { EDIT_CreateIndirect, "Edit", ID_EDIT_4, 334, 340, 50, 25, 0, 100, 0 },
  ...
  { EDIT_CreateIndirect, "Edit", ID_EDIT_5, 738, 337, 50, 25, 0, 100, 0 },
  { BUTTON_CreateIndirect, "Button", ID_BUTTON_2, 160, 390, 200, 40, 0, 0, 0 },
  { BUTTON_CreateIndirect, "Button", ID_BUTTON_3, 440, 390, 200, 40, 0, 0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetText(hItem, "Offsets");
    //
    // Initialization of 'Text'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_1);
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Cup1 C Offset");
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    //
    // Initialization of 'Text'
    //
    ...
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Cup 1 Si Offset");
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    //
    ...
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Cup 2 C Offset");
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    //
    // Initialization of 'Text'
    //
    ...
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Cup 2 Si Offset");
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    //
    // Initialization of 'Text'
    //
    ...
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    TEXT_SetText(hItem, "Set offset and slope to tune result");
    //
    // Initialization of 'Text'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_6);
    TEXT_SetFont(hItem, GUI_FONT_20_ASCII);
    TEXT_SetText(hItem, "-1.20");
    //
    // Initialization of 'Text'
    //
    ...
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Cup 1 Slope");
    //
    // Initialization of 'Text'
    //
    ...
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Cup 2 Slope");
    //
    // Initialization of 'Text'
    //
    ...
    BUTTON_SetFont(hItem, GUI_FONT_24_ASCII);
    BUTTON_SetText(hItem, "Copy Cup1 to Cup2");
    //
    // Initialization of 'Button'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_3);
    BUTTON_SetFont(hItem, GUI_FONT_24_ASCII);
    BUTTON_SetText(hItem, "Copy Cup2 to Cup1");
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_2: // Notifications sent by 'Button'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_SLIDER_0);
		  double val0 = (double)SLIDER_GetValue(hItem);
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_SLIDER_2);
		  SLIDER_SetValue(hItem, val0);
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_SLIDER_1);
		  double val1 = (double)SLIDER_GetValue(hItem);
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_SLIDER_3);
		  SLIDER_SetValue(hItem, val1);

		  hItem = WM_GetDialogItem(pMsg->hWin, ID_SLIDER_4);
		  double val2 = (double)SLIDER_GetValue(hItem);
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_SLIDER_5);
		  SLIDER_SetValue(hItem, val2);
		  char text[64];
		  val0 = -1.20 + val0 *0.024;
		  sprintf(text, "%.2f", val0);
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_2);
		  EDIT_SetText(hItem, text);

		  val1 = -1.20 + val1 *0.024;
		  sprintf(text, "%.2f", val1);
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_3);
		  EDIT_SetText(hItem, text);

		  val2 = 1.00 + val2 *0.04;
		  sprintf(text, "%.2f", val2);
		  hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_5);
		  EDIT_SetText(hItem, text);
