...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "LimitsWindow", ID_WINDOW_0, 0, 0, 800, 480, 0, 0, 0 },
  ...
  { TEXT_CreateIndirect, "Text", ID_TEXT_14, 42, 279, 315, 35, 0, 100, 0 },
  ...
  { TEXT_CreateIndirect, "Text", ID_TEXT_17, 480, 279, 250, 35, 0, 100, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetText(hItem, "Chemistry Limits");
    //
    // Initialization of 'Text'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_1);
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Minimum CE");
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    //
    // Initialization of 'Text'
    //
    ...
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    TEXT_SetFont(hItem, GUI_FONT_24_ASCII);
    TEXT_SetText(hItem, "Minimum Si");
    //
    // Initialization of 'Text'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_15);
    TEXT_SetFont(hItem, GUI_FONT_20_1);
    TEXT_SetText(hItem, "1.99");
    //
    // Initialization of 'Text'
    //
